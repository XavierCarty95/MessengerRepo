...
//  Messenger
//
//  Created by Xavier Carty on 2/22/22.
//
...
class RegisterViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Register", style: .done, target: self, action: #selector(didTappedRegistered))
  ...
  @objc private func didTappedRegistered() {
  ...
  @objc private func registerButtonTapped() {
    ...
    DatabaseManager.shared.userExists(with: email) { [weak self] exist in
      ...
      guard !exist else {
        //user already exist
        strongSelf.alertUserLoginError(message: "Looks like user account for that email account already exist")
        return
